...
export function viewFactory_Toolbar0(viewUtils:import4.ViewUtils,parentInjector:import5.Injector,declarationEl:import2.AppElement):import1.AppView<import3.Toolbar> {
  if ((renderType_Toolbar === (null as any))) { (renderType_Toolbar = viewUtils.createRenderComponentType('/Users/mackalvin/Project/Intuitive Surgical/demo/ISI-V2/node_modules/ionic-angular/components/toolbar/toolbar.d.ts class Toolbar - inline template',4,import11.ViewEncapsulation.None,styles_Toolbar,{})); }
