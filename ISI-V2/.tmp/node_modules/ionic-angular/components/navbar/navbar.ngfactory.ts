...
export function viewFactory_Navbar0(viewUtils:import4.ViewUtils,parentInjector:import5.Injector,declarationEl:import2.AppElement):import1.AppView<import3.Navbar> {
  if ((renderType_Navbar === (null as any))) { (renderType_Navbar = viewUtils.createRenderComponentType('/Users/mackalvin/Project/Intuitive Surgical/demo/ISI-V2/node_modules/ionic-angular/components/navbar/navbar.d.ts class Navbar - inline template',4,import13.ViewEncapsulation.None,styles_Navbar,{})); }
