...
export function viewFactory_Spinner0(viewUtils, parentInjector, declarationEl) {
    if ((renderType_Spinner === null)) {
        (renderType_Spinner = viewUtils.createRenderComponentType('/Users/mackalvin/Project/Intuitive Surgical/demo/ISI-V2/node_modules/ionic-angular/components/spinner/spinner.d.ts class Spinner - inline template', 0, import10.ViewEncapsulation.None, styles_Spinner, {}));
    }
