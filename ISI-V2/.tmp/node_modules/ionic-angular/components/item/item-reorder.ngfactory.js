...
export function viewFactory_Reorder0(viewUtils, parentInjector, declarationEl) {
    if ((renderType_Reorder === null)) {
        (renderType_Reorder = viewUtils.createRenderComponentType('/Users/mackalvin/Project/Intuitive Surgical/demo/ISI-V2/node_modules/ionic-angular/components/item/item-reorder.d.ts class Reorder - inline template', 0, import10.ViewEncapsulation.None, styles_Reorder, {}));
    }
