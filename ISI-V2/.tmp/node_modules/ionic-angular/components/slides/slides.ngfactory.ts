...
export function viewFactory_Slides0(viewUtils:import4.ViewUtils,parentInjector:import5.Injector,declarationEl:import2.AppElement):import1.AppView<import3.Slides> {
  if ((renderType_Slides === (null as any))) { (renderType_Slides = viewUtils.createRenderComponentType('/Users/mackalvin/Project/Intuitive Surgical/demo/ISI-V2/node_modules/ionic-angular/components/slides/slides.d.ts class Slides - inline template',1,import10.ViewEncapsulation.None,styles_Slides,{})); }
...
export function viewFactory_Slide0(viewUtils:import4.ViewUtils,parentInjector:import5.Injector,declarationEl:import2.AppElement):import1.AppView<import3.Slide> {
  if ((renderType_Slide === (null as any))) { (renderType_Slide = viewUtils.createRenderComponentType('/Users/mackalvin/Project/Intuitive Surgical/demo/ISI-V2/node_modules/ionic-angular/components/slides/slides.d.ts class Slide - inline template',1,import10.ViewEncapsulation.None,styles_Slide,{})); }
