...
export function viewFactory_SegmentButton0(viewUtils:import4.ViewUtils,parentInjector:import5.Injector,declarationEl:import2.AppElement):import1.AppView<import3.SegmentButton> {
  if ((renderType_SegmentButton === (null as any))) { (renderType_SegmentButton = viewUtils.createRenderComponentType('/Users/mackalvin/Project/Intuitive Surgical/demo/ISI-V2/node_modules/ionic-angular/components/segment/segment.d.ts class SegmentButton - inline template',1,import9.ViewEncapsulation.None,styles_SegmentButton,{})); }
